...
//	}
	...
	public static void addNonDirectedEdge(String l1, String l2, Set<Vertex> vertices, Map<Vertex, Set<Vertex>> adjacentList){
		addEdge(l1, l2, vertices, adjacentList);
		addEdge(l2, l1, vertices, adjacentList);
	}
	
	public static void addEdge(String fromLabel, String toLabel, Set<Vertex> vertices, Map<Vertex, Set<Vertex>> adjacentList){
